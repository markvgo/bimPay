...
import au.com.bim.pay.web.EmployeeController;
...
privileged aspect EmployeeController_Roo_Controller {
    ...
    void EmployeeController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("employee_birthday_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
    
    void EmployeeController.populateEditForm(Model uiModel, Employee employee) {
        uiModel.addAttribute("employee", employee);
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("pays", Pay.findAllPays());
        uiModel.addAttribute("workdones", WorkDone.findAllWorkDones());
        uiModel.addAttribute("provinces", Arrays.asList(Province.values()));
    }
